    ...
    <div class="ui container">
        ...
        <div class="ui grid">
            ...
            <div class="twelve wide column">
                ...
                <h2 class="ui block header">The first step</h2>
                ...
                <h2 class="ui block header">Katsina</h2>
                <div class="ui medium images">
                ...
                <h2 class="ui block header">A chance</h2>
                <div class="ui medium images">
                ...
                <h2 class="ui block header">Jabia</h2>
                <div class="ui medium images">
                ...
                <h2 class="ui block header"> change of direction</h2>
                <div class="ui medium images">
                ...
                <h2 class="ui block header">Gift a smile</h2>
                <div class="ui medium images">
                    <img class="ui medium rounded image" src="img/orphan-gallery-1.jpg">
                    <img class="ui medium rounded image" src="img/orphan-gallery-3.jpg">
                    <img class="ui medium rounded image" src="img/orphan-gallery-5.jpg">
                ...
                <h2 class="ui block header">Save a child</h2>
                <div class="ui medium images">
