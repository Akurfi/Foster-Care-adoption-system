    ...
    <div class="ui container">
        ...
        <div class="ui grid">
            ...
            <div class="twelve wide column">
                ...
                <p><a class="fluid ui button" href="donation-form.php">Click here to make your contribution</a></p>
                

                <strong>Guideline for making contribution:</strong>
                <ul>
                    <li>N. 200/- a month, can give a child Nutrition at learning centre.</li>
                    <li>N.300/- a month, can give a child Nutrition & After-school support.</li>
                    <li>N.400/- a month, can give a child complete package of Nutritio, health check-up, after-school, celebration of festivals etc.</li>
                    <li>N.1000/- a month, can be used for Sensitization & Awareness Programs including Media campaigns, workshops, seminars and capacity building initiatives.</li>
                    <li>N.5000/- a month, can be used for Infrastruture set up.</li>
                    <li>N.50000/- a month, can be used for Corpus Fund.</li>
                </ul>
